/* ═══════════════════════════════════════════════════════════════════
   SquadTab.tsx — Your squad with filters & actions
   ═══════════════════════════════════════════════════════════════════ */
...
const SquadTab: React.FC = () => {
  const { getActiveClubPlayers, listPlayer, unlistPlayer, placeBid } = useTransfer();
      ...
      {bidModal && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
          <div className="bg-[#1e1e1e] border-2 border-[#efe56b] p-4 rounded w-80">
            ...
            <p className="text-[#98ca7a] text-[8px] mb-3">Current Value: €{(bidModal.value / 1_000_000).toFixed(1)}M | Wage: €{bidModal.wage.toLocaleString()}/w</p>
